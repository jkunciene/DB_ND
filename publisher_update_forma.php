...
<div class="container">
  <header>
          <h2 class="bg-light p-3 text-center">Update Publisher</h2>
  </header>
<form action="publisherupdate.php" method="get">
  <div class="form-group">
    <label for="book">Publisher ID</label>
    <input type="text"  id="id" name="id" class="form-control" value="<?php $ats = getPublisherID($_GET['nr']); echo $ats['id']; ?>" name="id" >
  </div>
    <div class="form-group">
...
function myFunction() {
  var txt;
  if (confirm("yuo will update Publisher!")) {
    txt = "Tu atnaujinsi leideja!";
  } else {
